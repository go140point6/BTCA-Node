...
static const CRPCConvertParam vRPCConvertParams[] = {
    ...
    { "listreceivedbyanonymousaddress", 1 },
    ...
    { "getbalance", 2 },
    { "getbalance", 3 },
    { "getanonymousbalance", 1 },
    { "getanonymousbalance", 2 },
    { "rawanonymoussendmany", 1 },
    { "rawanonymoussendmany", 2 },
    { "rawanonymoussendmany", 3 },
    { "anonymoussendmany", 1 },
    { "anonymoussendmany", 2 },
    { "anonymoussendmany", 3 },
    { "getblockhash", 0 },
    ...
    { "listunspent", 2 },
    { "listunspent", 3 },
    { "listanonymousunspent", 0 },
    { "listanonymousunspent", 1 },
    { "listanonymousunspent", 2 },
    { "listanonymousunspent", 3 },
    { "logging", 0 },
    { "logging", 1 },
    { "getblock", 1 },
    { "getblockheader", 1 },
