...
//
// The Masternode Class. It contains the input of the 100 BTCA, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 100 BTCA - checking if valid masternode)
