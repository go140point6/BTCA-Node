...
// Copyright (c) 2015-2020 The BTCAX developers
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    const std::string example_address = "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\"";
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
                ...
                "Metadata for anonymous addresses is available only if the wallet is unlocked.\n"
                "{Result:\n"
                "  \"address\" : \"address\",              (string) The bitcoin address validated.\n"
                "  \"isshield\" : true|false,            (boolean) If the address is anonymous or transparent.\n"
...
UniValue getnewstakingaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nReturns a new BTCA cold staking address for receiving delegated cold stakes.\n"
...
UniValue getnewanonymousaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
                "getnewanonymousaddress\n"
                "\nReturns a new anonymous address for receiving payments.\n"
                + HelpRequiringPassphrase() + "\n"

                "\nResult:\n"
                "\"address\"    (string) The new anonymous address.\n"

                "\nExamples:\n"
                + HelpExampleCli("getnewanonymousaddress", "")
                + HelpExampleRpc("getnewanonymousaddress", "")
        );
...
UniValue listanonymousunspent(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
                "listanonymousunspent ( minconf maxconf includeWatchonly [\"anonymous_addr\",...] )\n"
                "\nReturns array of unspent anonymous notes with between minconf and maxconf (inclusive) confirmations.\n"
                ...
                "4. \"addresses\"      (string) A json array of anonymous addrs to filter on.  Duplicate addresses not allowed.\n"
                "    [\n"
                "      \"address\"     (string) anonymous addr\n"
                "      ,...\n"
                "    ]\n"
                ...
                "    \"address\" : \"address\",    (string) the anonymous address\n"
                ...
                "\nExamples\n"
                + HelpExampleCli("listanonymousunspent", "")
                + HelpExampleCli("listanonymousunspent", "6 9999999 false \"[\\\"ptestsapling1h0w73csah2aq0a32h42kr7tq4htlt5wfn4ejxfnm56f6ehjvek7k4e244g6v8v3pgylmz5ea8jh\\\",\\\"ptestsapling1h0w73csah2aq0a32h42kr7tq4htlt5wfn4ejxfnm56f6ehjvek7k4e244g6v8v3pgylmz5ea8jh\\\"]\"")
                + HelpExampleRpc("listanonymousunspent", "6 9999999 false \"[\\\"ptestsapling1h0w73csah2aq0a32h42kr7tq4htlt5wfn4ejxfnm56f6ehjvek7k4e244g6v8v3pgylmz5ea8jh\\\",\\\"ptestsapling1h0w73csah2aq0a32h42kr7tq4htlt5wfn4ejxfnm56f6ehjvek7k4e244g6v8v3pgylmz5ea8jh\\\"]\"")
        );
    ...
    if (request.params.size() > 3) {
        ...
        for (const UniValue& o : addresses.getValues()) {
            ...
            if (!IsValidPaymentAddress(shieldAddr)) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, std::string("Invalid parameter, address is not a valid anonymous address: ") + address);
            }
...
UniValue delegatoradd(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("delegatoradd", "Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb") +
            HelpExampleRpc("delegatoradd", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\"") +
            HelpExampleRpc("delegatoradd", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" \"myPaperWallet\""));
...
UniValue delegatorremove(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("delegatorremove", "Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb") +
            HelpExampleRpc("delegatorremove", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\""));
    ...
    const CKeyID* keyID = boost::get<CKeyID>(&dest);
    if (!keyID)
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Unable to get KeyID from BTCAXaddress");

    if (!pwalletMain->HasAddressBook(*keyID))
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Unable to get BTCAXaddress from addressBook");
...
UniValue listdelegators(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "   \"address\": \"xxx\",  (string) BTCAXaddress string\n"
            "   }\n"
            "  ...\n"
            "]\n"
...
UniValue listanonymousaddresses(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
                "listanonymousaddresses ( includeWatchonly )\n"
                "\nReturns the list of anonymous addresses belonging to the wallet.\n"
                ...
                "\nResult:\n"
                "[                     (json array of string)\n"
                "  \"addr\"           (string) a anonymous address belonging to the wallet\n"
                "  ,...\n"
                "]\n"

                "\nExamples:\n"
                + HelpExampleCli("listanonymousaddresses", "")
                + HelpExampleRpc("listanonymousaddresses", "")
        );
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new BTCAXaddress, for receiving change.\n"
...
UniValue setlabel(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setlabel", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" \"tabby\"") + HelpExampleRpc("setlabel", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", \"tabby\""));
...
/*
 * redirect sendtoaddress/sendmany inputs to anonymoussendmany implementation (CreateShieldedTransaction)
 */
...
{
    // convert params to 'anonymoussendmany' format
    JSONRPCRequest req;
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" 0.1") +
            HelpExampleCli("sendtoaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", 0.1, \"donation\", \"seans outpost\""));
    ...
    const std::string commentStr = (request.params.size() > 2 && !request.params[2].isNull()) ? request.params[2].get_str() : "";
    const std::string toStr = (request.params.size() > 3 && !request.params[3].isNull()) ? request.params[3].get_str() : "";
...
UniValue CreateColdStakeDelegation(const UniValue& params, CWalletTx& wtxNew, CReserveKey& reservekey)
{
    ...
    if (!IsValidDestination(stakeAddr) || !isStaking)
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BTCAXstaking address");
    ...
    if (params.size() > 2 && !params[2].isNull() && !params[2].get_str().empty()) {
        ...
        if (!IsValidDestination(dest) || isStaking)
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BTCAXspending address");
...
UniValue delegatestake(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            "delegatestake \"stakingaddress\" amount ( \"owneraddress\" fExternalOwner fUseDelegated fFromAnonymous fForceNotEnabled )\n"
            "\nDelegate an amount to a given address for cold staking. The amount is a real and is rounded to the nearest 0.00000001\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"stakingaddress\"      (string, required) The btca staking address to delegate.\n"
            "2. \"amount\"              (numeric, required) The amount in BTCA to delegate for staking. eg 100\n"
            "3. \"owneraddress\"        (string, optional) The btca address corresponding to the key that will be able to spend the stake.\n"
            ...
            "6. \"fFromAnonymous\"         (boolean, optional, default = false) delegate anonymous funds.\n"
...
UniValue rawdelegatestake(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            "rawdelegatestake \"stakingaddress\" amount ( \"owneraddress\" fExternalOwner fUseDelegated fFromAnonymous )\n"
            "\nDelegate an amount to a given address for cold staking. The amount is a real and is rounded to the nearest 0.00000001\n"
...
UniValue getanonymousbalance(const JSONRPCRequest& request)
{
    if (!pwalletMain)
        return NullUniValue;
    ...
    if (request.fHelp || request.params.size() > 3)
        throw std::runtime_error(
                "getanonymousbalance \"address\" ( minconf includeWatchonly )\n"
                "\nReturn the total anonymous value of funds stored in the node's wallet or if an address was given,"
                "\nreturns the balance of the anonymous addr belonging to the node's wallet.\n"
                ...
                "\nResult:\n"
                "amount              (numeric) the total balance of anonymous funds (in Sapling addresses)\n"

                "\nExamples:\n"
                "\nThe total amount in the wallet\n"
                + HelpExampleCli("getanonymousbalance", "")
                + HelpExampleCli("getanonymousbalance", "ptestsapling1h0w73csah2aq0a32h42kr7tq4htlt5wfn4ejxfnm56f6ehjvek7k4e244g6v8v3pgylmz5ea8jh") +
                "\nThe total amount in the wallet at least 5 blocks confirmed\n"
                + HelpExampleCli("getanonymousbalance", "\"*\" \"5\"") +
                "\nAs a json rpc call\n"
                + HelpExampleRpc("getanonymousbalance", "\"*\" \"5\"")
        );
    ...
    if (request.params.size() > 0) {
        ...
        if (addressStr.empty() || addressStr != "*") {
            ...
            if (!address) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, "Invalid anonymous address");
            }
        }
    }
...
UniValue viewanonymoustransaction(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
                "viewanonymoustransaction \"txid\"\n"
                "\nGet detailed anonymous information about in-wallet transaction \"txid\"\n"
                + HelpRequiringPassphrase() + "\n"
                "\nArguments:\n"
                ...
                "      \"address\" : \"btcaaddress\",     (string) The BTCAXaddress involved in the transaction\n"
                ...
                "\nExamples:\n"
                + HelpExampleCli("viewanonymoustransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
                + HelpExampleRpc("viewanonymoustransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
        );
    ...
    if (!wtx.tx->IsShieldedTx()) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid transaction, no anonymous data available");
    }
...
static SaplingOperation CreateShieldedTransaction(const JSONRPCRequest& request)
{
    ...
    if (sendFromStr == "from_transparent") {
        ...
        if (!IsValidDestination(fromTAddressDest)) {
            ...
            if (!IsValidPaymentAddress(res)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid from address, should be a taddr or anonymous addr.");
            }
            ...
            if (!pwalletMain->HaveSpendingKeyForPaymentAddress(fromShieldedAddress)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "From address does not belong to this node, anonymous addr spending key not found.");
            }
    ...
    for (const UniValue& o : outputs.getValues()) {
        ...
        if (!memoValue.isNull()) {
            ...
            if (!saddr) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, "Memo cannot be used with a taddr. It can only be used with a anonymous addr.");
            }
    ...
    if (fromSapling && nMinDepth == 0) {
        throw JSONRPCError(RPC_INVALID_PARAMETER, "Minconf cannot be zero when sending from anonymous addr");
    }
...
UniValue anonymoussendmany(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4)
        throw std::runtime_error(
                "anonymoussendmany \"fromaddress\" [{\"address\":... ,\"amount\":...},...] ( minconf fee )\n"
                "\nSend to many recipients. Amounts are decimal numbers with at most 8 digits of precision."
                "\nChange generated from a transparent addr flows to a new  transparent addr address, while change generated from a anonymous addr returns to itself."
                "\nWhen sending coinbase UTXOs to a anonymous addr, change is not allowed. The entire value of the UTXO(s) must be consumed."
                + HelpRequiringPassphrase() + "\n"
                "\nArguments:\n"
                "1. \"fromaddress\"         (string, required) The transparent addr or anonymous addr to send the funds from.\n"
                ...
                "    [{\n"
                "      \"address\":address  (string, required) The address is a transparent addr or anonymous addr\n"
                "      \"amount\":amount    (numeric, required) The numeric amount in " + "BTCA" + " is the value\n"
                "      \"memo\":memo        (string, optional) If the address is a anonymous addr, message string of max 512 bytes\n"
                "    }, ... ]\n"
                "3. minconf               (numeric, optional, default=1) Only use funds confirmed at least this many times.\n"
                "4. fee                   (numeric, optional), The fee amount to attach to this transaction.\n"
                "                            If not specified, the wallet will try to compute the minimum possible fee for a anonymous TX,\n"
                "                            based on the expected transaction size and the current value of -minRelayTxFee.\n"
                "\nResult:\n"
                "\"id\"          (string) transaction hash in the network\n"
                "\nExamples:\n"
                + HelpExampleCli("anonymoussendmany",
                                 "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" '[{\"address\": \"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\" ,\"amount\": 5.0}]'")
                + HelpExampleRpc("anonymoussendmany",
                                 "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", [{\"address\": \"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\" ,\"amount\": 5.0}]")
        );
...
UniValue rawanonymoussendmany(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4)
        throw std::runtime_error(
                "rawanonymoussendmany \"fromaddress\" [{\"address\":... ,\"amount\":...},...] ( minconf fee )\n"
                ...
                "\nExamples:\n"
                + HelpExampleCli("rawanonymoussendmany",
                                 "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" '[{\"address\": \"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\" ,\"amount\": 5.0}]'")
                + HelpExampleRpc("rawanonymoussendmany",
                                 "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", [{\"address\": \"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\" ,\"amount\": 5.0}]")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("signmessage", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" \"my message\"") +
            "\nVerify the signature\n" +
            HelpExampleCli("verifymessage", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("signmessage", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", \"my message\""));
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("getreceivedbyaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" +
            HelpExampleCli("getreceivedbyaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" +
            HelpExampleCli("getreceivedbyaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" 6") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("getreceivedbyaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\", 6"));
...
UniValue getbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || (request.params.size() > 4 ))
        throw std::runtime_error(
            "getbalance ( minconf includeWatchonly includeDelegated includeAnonymous )\n"
            ...
            "4. includeAnonymous    (bool, optional, default=true) Also include anonymous balance\n"

            "\nResult:\n"
            "amount              (numeric) The total amount in BTCA received for this wallet.\n"
...
UniValue getcoldstakingbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || (request.params.size() != 0))
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "amount              (numeric) The total amount in BTCA received for this wallet in P2CS contracts.\n"
 ...
 * If any recipient is a shield address, instead it uses [anonymoussendmany "from_transparent"].
 */
UniValue sendmany(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nSend to multiple destinations. Recipients are transparent or anonymous BTCA addresses.\n"
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The btca address (either transparent or anonymous) is the key,\n"
            "                                     the numeric amount in BTCA is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            HelpExampleCli("sendmany", "\"\" \"{\\\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\\\":0.01,\\\"AUAk1nSY2nA339jsVqtyeVY5PJ5hPuJq7x\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" +
            HelpExampleCli("sendmany", "\"\" \"{\\\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\\\":0.01,\\\"AUAk1nSY2nA339jsVqtyeVY5PJ5hPuJq7x\\\":0.02}\" 6 \"testing\"") +
            ...
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendmany", "\"\", \"{\\\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\\\":0.01,\\\"AUAk1nSY2nA339jsVqtyeVY5PJ5hPuJq7x\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "Each key is a BTCAXaddress or hex-encoded public key.\n"
            ...
            HelpExampleCli("addmultisigaddress", "2 \"[\\\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\\\",\\\"AUAk1nSY2nA339jsVqtyeVY5PJ5hPuJq7x\\\"]\"") +
            "\nAs json rpc call\n" +
            HelpExampleRpc("addmultisigaddress", "2, \"[\\\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\\\",\\\"AUAk1nSY2nA339jsVqtyeVY5PJ5hPuJq7x\\\"]\""));
...
UniValue listreceivedbyaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            HelpExampleRpc("listreceivedbyaddress", "6, true, true, \"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\""));
...
UniValue listreceivedbyanonymousaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size()==0 || request.params.size() >2)
        throw std::runtime_error(
                "listreceivedbyanonymousaddress \"address\" ( minconf )\n"
                "\nReturn a list of amounts received by a anonymous addr belonging to the node's wallet.\n"
                ...
                "\nExamples:\n"
                + HelpExampleCli("listreceivedbyanonymousaddress", "\"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\"")
                + HelpExampleRpc("listreceivedbyanonymousaddress", "\"ps1ra969yfhvhp73rw5ak2xvtcm9fkuqsnmad7qln79mphhdrst3lwu9vvv03yuyqlh42p42st47qd\"")
        );
    ...
    if (!sspkm->PaymentAddressBelongsToWallet(shieldAddr)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "From address does not belong to this node, anonymous addr spending key or viewing key not found.");
    }
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 6) throw std::runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"address\":\"btcaaddress\",    (string) The btca address of the transaction.\n"
            "    \"category\":\"category\",      (string) The transaction category (send|receive|orphan|immature|generate).\n"
            "    \"amount\": x.xxx,          (numeric) The amount in BTCA. This is negative for the 'send' category, and positive\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"Aa7vXMBfxoVp1JcWGmd2F1cApdLm2dkLhb\" 1.0") +
...
UniValue autocombinerewards(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || (fEnable && request.params.size() != 2) || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nWallet will automatically monitor for any coins with value below the threshold amount, and combine them if they reside with the same BTCAXaddress\n"
...
{ //  category              name                        actor (function)           okSafeMode
  //  --------------------- ------------------------    -----------------------    ----------
    ...
    /** Sapling functions */
    { "wallet",             "getnewanonymousaddress",           &getnewanonymousaddress,            true  },
    { "wallet",             "listanonymousaddresses",           &listanonymousaddresses,            false },
    ...
    { "wallet",             "getanonymousbalance",              &getanonymousbalance,               false },
    { "wallet",             "listanonymousunspent",             &listanonymousunspent,              false },
    { "wallet",             "rawanonymoussendmany",             &rawanonymoussendmany,              false },
    { "wallet",             "anonymoussendmany",                &anonymoussendmany,                 false },
    { "wallet",             "listreceivedbyanonymousaddress",   &listreceivedbyanonymousaddress,    false },
    { "wallet",             "viewanonymoustransaction",         &viewanonymoustransaction,          false },
