// Copyright (c) 2019-2020 The BTCAX developers
    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Containers
    setCssProperty({this, ui->left}, "container-transparent");
    ui->left->setContentsMargins(0,0,0,0);

    // Title
    setCssTitleScreen(ui->labelTitle);
    setCssProperty(ui->labelTitle, "text-title-dash");
...
#ifdef USE_QTCHARTS
    setCssProperty(ui->right, "container-transparent-right");
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(32,60,83));
    set1->setColor(QColor(71,135,199));
