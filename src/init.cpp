...
void PrepareShutdown()
{
    ...
    util::ThreadRename("btca-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-masternodeaddr=<n>", strprintf(_("Set external address:port to get to this masternode (example: %s)"), "128.127.106.235:34472"));
...
{
    util::ThreadRename("btca-loadblk");
